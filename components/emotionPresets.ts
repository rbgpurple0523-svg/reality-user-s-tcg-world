...
export const EMOTION_PRESETS: EmotionPreset[] = [
  ...
  },
  {
    ...
    effectCategory: 'スコア', statEffect: 'スコアを固定値で増加', effectAmount: '+500',
    description: '使用時に自分の現在クラスのスコアを500増やす。', note: '使用時に即時反映。持続しない。',
  },
  {
    ...
    effectCategory: 'スコア', statEffect: 'スコアを固定値で減少', effectAmount: '-500',
    description: '使用時に相手の現在クラスのスコアを500減らす。', note: '使用時に即時反映。0を下回らない。持続しない。',
  },
  {

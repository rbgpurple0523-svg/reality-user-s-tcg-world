...
export interface EmotionPreset {
  ...
  description: string;
  note?: string;
  battleEffect: BattlePreResultEffectKey;
}
...
export const EMOTION_PRESETS: EmotionPreset[] = [
  ...
  {
    id: 'emo_21', name: 'ラッキーコイン', duration: '永続', target: '自分',
    effectCategory: 'スコア', statEffect: 'スコアを固定値で増加', effectAmount: '+100',
    description: '自分のスコアを固定値で増加させる。', note: '最大4ターン',
    battleEffect: 'support-impact',
  },
  {
    id: 'emo_22', name: 'うっかりミス', duration: '永続', target: '相手',
